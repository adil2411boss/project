            ...
            if isinstance(drafts, list):
                ...
                for draft in drafts:
                    if isinstance(draft, dict):
                        ...
                        if title or essay:
                            cleaned.append({"title": title, "essay": essay})
        ...
        <section class="panel">
            ...
            <div class="grid">
                ...
                <article class="card fade-card">
                    ...
                    <p><strong>Brand:</strong><br>UniFlow is now live in your workspace.</p>
                    <p><strong>Saved essay drafts:</strong><br>{{ drafts_count }} draft{{ '' if drafts_count == 1 else 's' }} currently saved.</p>
                    <p><strong>Application target:</strong><br><span id="target-preview">{{ saved_region }}</span></p>
                </article>
            </div>
        </section>
    </main>
        ...
        if action == "load_draft":
            ...
            if not essay_title and not essay:
                ...
                if selected_draft_index is not None and selected_draft_index < len(drafts):
                    drafts[selected_draft_index] = {"title": essay_title, "essay": essay}
                    selected_draft_index = selected_draft_index
                else:
                    drafts.append({"title": essay_title, "essay": essay})
